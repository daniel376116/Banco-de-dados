...
-- 9. Precisamos listar os filmes de 'Mistério e Suspense' OU 'Ficção e Fantasia'.
	...
	select * from filmes
    where genero = 'Mistério e Suspense' or genero = 'ficcção e fantasia';
...
-- Atualize o estado e a região dele no banco de dados.
    ...
    update clientes
    set estado = 'São Paulo', regiao = 'Sudeste'
...
-- Qual é o erro? _Faltou sinal de igualdade _________________________________________________________
-- Correção:
	SELECT titulo, genero, ano_lancamento FROM filmes WHERE ano_lancamento = 2005 ORDER BY titulo;
...
-- Qual é o erro? ____Estado em vez de região______________________________________________________
-- Correção:
...
-- Qual é o erro? __NULL dentro de aspas simples________________________________________________________
-- Correção:
...
-- Qual é o erro? _actor no lugar de atores e nacionalidade sendo aplicada e não existindo nesse banco de dados______________________________________________________
-- Correção:
	SELECT * FROM atores;
